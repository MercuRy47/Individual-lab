...
/* Date: 04/09/2024
/* Description: โปรแกรมแสดงข้อมูลสิ้นค้าที่มีในอยู่ระบบ แบบเลือกหมวดได้ +แปลงจา $ เป็น ฿
/*************************************************************************************/
package SE_STORE_3;
...
public class SEStore {
    ...
    public void showOptions_dis2(){
        ...
        store.loadProductFromFile("SE_STORE_3/CATEGORY.txt");
    ...
    public static void main(String[] args) {
        ...
        // Load data
        store.loadProductFromFile("SE_STORE_3/PRODUCT.txt");
        store.loadProductFromFile("SE_STORE_3/CATEGORY.txt");
        while(true) {
            // Display#1
